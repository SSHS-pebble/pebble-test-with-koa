...
module.exports = async (ctx, next) => {
    if(!ctx.request.body.email || !ctx.request.body.name || !ctx.request.body.code || 1 > parseInt(ctx.request.body.grade) || 3 < parseInt(ctx.request.body.grade) || !ctx.request.body.password) {
        ctx.throw(400);
    }
